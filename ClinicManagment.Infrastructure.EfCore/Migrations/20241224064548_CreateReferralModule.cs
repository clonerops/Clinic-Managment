...
{
    /// <inheritdoc />
    public partial class CreateReferralModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferralDate = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Referrals_PatientFiles_PatientFileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Referrals_PatientFileId",
                table: "Referrals",
